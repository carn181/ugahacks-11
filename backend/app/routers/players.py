...
from app.schemas.schemas import Profile, ProfileUpdate, LocationUpdate, Item
...
async def sync_player_location(sync_data: LocationUpdate):
    ...
    await location_service.update_owned_items_location(player_id, sync_data.latitude, sync_data.longitude)
    
    return {"status": "synced", "location": {"lat": sync_data.latitude, "lng": sync_data.longitude}}