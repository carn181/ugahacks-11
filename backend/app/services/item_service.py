...
class ItemService:
    ...
    async def check_proximity(self, item_id, player_latitude: float, player_longitude: float, max_distance: float) -> bool:
    ...
    async def spawn_random_item(self, map_id, item_type: str, subtype: str, latitude: float, longitude: float):
