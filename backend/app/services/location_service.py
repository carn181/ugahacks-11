...
class LocationService:
    ...
    async def update_owned_items_location(self, player_id, latitude: float, longitude: float):
    ...
    async def calculate_distance(self, item_id, player_latitude: float, player_longitude: float) -> Optional[float]:
